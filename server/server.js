...
// Trust reverse proxy / cloud load balancer headers (Render, Cloudflare, NGINX, AWS ALB)
...
// Load Balancer Instance Identification & Response Headers
app.use((req, res, next) => {
    res.setHeader('X-Served-By', process.env.RENDER_INSTANCE_ID || process.env.HOSTNAME || 'node-cluster-instance');
    next();
});
